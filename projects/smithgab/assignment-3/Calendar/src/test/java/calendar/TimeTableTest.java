	 ...
	 // public void test02()  throws Throwable  {
		 // TimeTable t=new TimeTable();
			...
			// int thisDay = rightnow.get(Calendar.DAY_OF_MONTH);
			 ...
			 // int startHour=15;
			 // int startMinute=30;
			 // int startDay=(thisDay-3);  					//Alter day to be before this point in time
			 // int startMonth=thisMonth; 	//8
			 // int startYear=thisYear; 	//2017
        // String title="Birthday Party";
        // String description="This is my birthday party.";
        // // Create a valid appointment!
       ...
       // appt.setRecurrence(recurringDays, Appt.RECUR_BY_MONTHLY, 0, 1);
		...
		// t.deleteAppt(appts, appt);						//hitting delete functions while invalid appts
		// assertEquals(1, appts);
	 // }
		 ...
		 // public void test03()  throws Throwable  {
			 // TimeTable t=new TimeTable();
				...
				// int thisDay = rightnow.get(Calendar.DAY_OF_MONTH);
				 ...
				 // int startHour=15;
				 // int startMinute=30;
				 // int startDay=(thisDay);  					//Alter day to be before this point in time
				 // int startMonth=thisMonth; 	//8
				 // int startYear=thisYear; 	//2017
	        // String title="Birthday Party";
	        // String description="This is my birthday party.";
	        ...
	        // appts.add(appt);
			   	 ...
			   	 // startHour=17;
				 // startMinute=31;
				 // startDay=(thisDay);  					//Alter day to be before this point in time
	 ...
	 // }
		...
		// in particular case Appt.RECUR_BY_MONTHLY
		 public void test04()  throws Throwable  {
	        ...
	        //Change the  default recurring information in the object appt using setRecurrence method in the Appt class 
	        int[] recurringDays =  new int[71];
	       appt.setRecurrence(recurringDays, Appt.RECUR_BY_WEEKLY, 4, 12);
			//get a list of appointments for one day that are occurred between today and tomorrow!
	        GregorianCalendar firstDay = new GregorianCalendar(thisYear,thisMonth,thisDay);
	        //Create an identical object for the firstDay
			GregorianCalendar lastDay = (GregorianCalendar)firstDay.clone();
		 ...
		 // public void test05()  throws Throwable  {
	        ...
	        // appts.add(appt);
			   	 ...
			   	 // startHour=17;
				 // startMinute=31;
				 // startDay=(thisDay+3);  					//Alter day to be before this point in time
				 // startMonth=thisMonth; 	//8
				 // startYear=thisYear; 	//2017
		    // title="Birthday Party1";
		    // description="This is my birthday party.1";
